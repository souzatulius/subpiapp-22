...
const RankingSubs = () => {
  ...
  return <div className="space-y-6 bg-[#FFFAFA]">
      ...
      duration: 0.5
        ...
        <WelcomeCard title="Ranking da Zeladoria" description="Acompanhamento de desempenho e análises de ações, projetos e obras." icon={<BarChart3 className="text-blue-300 h-15 w-15" />} color="bg-gradient-to-r from-blue-700 to-blue-900" />
        ...
        {!isMobile && <div className="flex justify-end mt-4 space-x-2">
            ...
            <Button variant="outline" size="icon" className="bg-white hover:bg-gray-100 border-gray-200 rounded-lg" onClick={handleExportPDF}>
              <FileText className="h-5 w-5 text-gray-600" />
            </Button>
            
            <Button variant="outline" size="icon" className="bg-white hover:bg-gray-100 border-gray-200 rounded-lg" onClick={() => setFilterDialogOpen(true)}>
