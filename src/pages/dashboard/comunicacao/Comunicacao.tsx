...
const ComunicacaoDashboard: React.FC<ComunicacaoDashboardProps> = ({ 
  ...
  if (isLoading) {
    return (
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 flex justify-center items-center h-64">
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 pb-20 md:pb-6 space-y-5">
      {/* Welcome Card */}
      <WelcomeCard
        title="Comunicação"
