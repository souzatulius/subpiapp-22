  ...
  return <div className="bg-white rounded-lg shadow-lg p-8 w-full px-[15px] py-[35px]">
      ...
      <form onSubmit={handleLogin}>
        <div className="space-y-4">
          ...
          <button type="submit" className="w-full bg-[#003570] text-white py-3 px-4 rounded-lg hover:bg-blue-900 transition-all duration-200 flex items-center justify-center font-medium" disabled={loading}>
          ...
          <button type="button" onClick={handleGoogleLogin} className="w-full bg-white border border-gray-300 text-[#111827] py-3 px-4 rounded-lg hover:bg-gray-50 transition-all duration-200 flex items-center justify-center">
