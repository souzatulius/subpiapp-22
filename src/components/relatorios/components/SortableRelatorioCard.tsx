      ...
      <div className="relative h-full group">
        <div className="absolute top-0 right-0 p-1.5 z-10 flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
          {analysis && (
            <button
              ...
              className="p-1 rounded-full bg-white text-gray-600 hover:text-gray-800 shadow-sm hover:shadow transition-all"
        ...
        <div className="h-full">
          {showAnalysisOnly && analysis ? (
            <div className="p-4 bg-gradient-to-r from-gray-100 to-gray-50 rounded-lg border border-gray-300 shadow-sm h-full flex flex-col">
              <h3 className="text-lg font-medium text-gray-800 mb-2">{title} - Análise</h3>
        ...
        {isAnalysisExpanded && !showAnalysisOnly && analysis && (
          <motion.div 
            ...
            className="mt-2 p-3 bg-gray-100 rounded-md text-sm text-gray-700"
