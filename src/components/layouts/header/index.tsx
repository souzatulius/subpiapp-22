...
const Header: React.FC<HeaderProps> = ({
  ...
  return <header className="w-full border-b border-gray-200 flex justify-between items-center bg-white py-0 px-0">
      ...
      <div className="flex-1 flex justify-end">
        {showControls && user && <div className="flex items-center gap-2">
