        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center">
            {showControls && toggleSidebar && (
              <button onClick={toggleSidebar} className="p-2 rounded-md text-gray-500 hover:text-gray-900 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 lg:hidden">
