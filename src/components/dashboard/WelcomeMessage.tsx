...
const WelcomeMessage: React.FC = () => {
  ...
  return (
    <div className="col-span-4 mb-8">
      <Card className="bg-blue-50 text-blue-800 border border-blue-100 rounded-xl shadow-sm overflow-hidden">
        <CardContent className="p-4 flex items-start space-x-3">
          ...
          <div className="flex-grow">
            <div className="flex justify-between">
              <h3 className="font-medium mb-1 text-blue-800">Bem-vindo ao seu Dashboard Personalizado!</h3>
              <button 
                onClick={handleClose}
