...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({ isOpen }) => {
  ...
  return (
    <aside
      className={`${sidebarWidth} ${sidebarPadding} py-6 flex-shrink-0 border-r border-[#00357033] bg-[#051b2c] h-full min-h-screen sticky top-0 left-0 overflow-y-auto flex flex-col transition-all duration-300 ease-in-out`}
    >
