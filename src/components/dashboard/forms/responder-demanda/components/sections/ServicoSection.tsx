...
const ServicoSection: React.FC<ServicoSectionProps> = ({
  ...
  return <div className="p-4 bg-gray-50 border border-gray-200 rounded-xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {selectedDemanda.tema && <div className="space-y-1">
        ...
        {selectedDemanda.servico && <div className="space-y-1">
        ...
        {selectedDemanda.bairros && <div className="space-y-1">
        ...
        {selectedDemanda.distrito && <div className="space-y-1">
        ...
        {selectedDemanda.protocolo && <div className="space-y-1">
        ...
        {selectedDemanda.endereco && <div className="space-y-1">
