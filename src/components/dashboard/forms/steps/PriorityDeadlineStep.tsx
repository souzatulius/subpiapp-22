      ...
      <div>
        ...
        <div className="flex items-center mb-4">
          ...
          <div className="flex items-center p-2 rounded-lg bg-transparent">
            {/* Red Light */}
            <button onClick={() => handleSelectChange('prioridade', 'alta')} className={`w-14 h-14 rounded-full mr-4 transition-all ${formData.prioridade === 'alta' ? 'ring-4 ring-gray-400' : ''}`} style={{
            backgroundColor: '#FF4136'
          }} aria-label="Prioridade Alta" />
            {/* Yellow Light */}
            <button onClick={() => handleSelectChange('prioridade', 'media')} className={`w-14 h-14 rounded-full mr-4 transition-all ${formData.prioridade === 'media' ? 'ring-4 ring-gray-400' : ''}`} style={{
            backgroundColor: '#FFDC00'
          }} aria-label="Prioridade Média" />
            {/* Green Light */}
            <button onClick={() => handleSelectChange('prioridade', 'baixa')} className={`w-14 h-14 rounded-full transition-all ${formData.prioridade === 'baixa' ? 'ring-4 ring-gray-400' : ''}`} style={{
