    ...
    <div className="space-y-4">
        ...
        <div className="flex items-center mb-4">
          ...
          <div className="flex items-center p-2 rounded-lg bg-transparent">
            ...
            <button 
              ...
              className={`w-14 h-14 rounded-full mr-4 transition-all ${formData.prioridade === 'alta' ? 'ring-4 ring-gray-400' : ''}`} 
            ...
            <button 
              ...
              className={`w-14 h-14 rounded-full mr-4 transition-all ${formData.prioridade === 'media' ? 'ring-4 ring-gray-400' : ''}`} 
            ...
            <button 
              ...
              className={`w-14 h-14 rounded-full transition-all ${formData.prioridade === 'baixa' ? 'ring-4 ring-gray-400' : ''}`} 
      ...
      <div>
        ...
        <div className="flex space-x-4">
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button variant="outline" className={cn("w-full justify-start text-left font-normal", !formData.prazo_resposta && "text-muted-foreground")}>
                  ...
                  {formData.prazo_resposta ? format(new Date(formData.prazo_resposta), "dd/MM/yyyy", { locale: ptBR }) : <span>Selecione uma data</span>}
                </Button>
              </PopoverTrigger>
          ...
          <div className="w-24">
            <Select 
              value={formData.prazo_resposta ? format(new Date(formData.prazo_resposta), "HH:mm") : undefined} 
