        ...
        <form onSubmit={handleSubmit} className="relative">
          <div className="relative">
            ...
            <Input
              ref={inputRef}
              type="text" 
              className="pl-14 pr-4 py-5 rounded-xl border border-gray-300 w-full bg-transparent text-lg font-medium text-gray-800 placeholder:text-gray-400 placeholder:font-normal"
