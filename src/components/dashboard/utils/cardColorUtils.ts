...
export const getColorClasses = (color: CardColor): string => {
  switch (color) {
    ...
    case 'green-neon': return 'bg-[#66FF66] text-gray-900'; // Verde Neon - dark text for better contrast
...
export const getTextColorClass = (color: CardColor, cardId?: string): string => {
  ...
  switch (color) {
    ...
    case 'blue-light':
    case 'green-neon':
      return 'text-gray-900'; // Dark text on light blue and green backgrounds
    case 'green-dark':
