  ...
  return (
    <div className="min-h-screen flex flex-col bg-white md:bg-transparent">
      ...
      <div className="flex flex-1 flex-col md:flex-row">
        ...
        {!isMobile && (
          <div className="hidden md:flex md:w-1/2 bg-white px-6 md:px-16 lg:px-20 py-12 flex-col justify-center">
            <LeftContentSection />
          </div>
        )}
        ...
        <div 
          className="w-full min-h-[calc(100vh-80px)] md:min-h-0 md:w-1/2 flex flex-col items-start justify-start pt-10 md:pt-0 md:items-center md:justify-center p-8 relative bg-subpi-blue md:bg-subpi-blue"
          style={!isMobile ? {
