...
const LeftContentSection: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto md:mx-auto flex flex-col items-center text-center">
      <h1 className="text-6xl md:text-7xl font-bold leading-[1.1] md:leading-[1.1] mb-6 lg:text-9xl">
      ...
      <div className="flex flex-wrap gap-4 mb-12 transition-all duration-300 justify-center">
        {user ? (
          ...
          <>
            <Button 
              asChild 
              className={`rounded-xl py-2 px-6 flex items-center shadow-md transition-all duration-300 ${isLoginPage ? "bg-gray-400 text-gray-100 cursor-not-allowed hover:bg-gray-400 hover:shadow-md" : "bg-[#002855] hover:bg-[#001f40] text-white hover:shadow-lg"}`} 
