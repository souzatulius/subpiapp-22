...
const LeftContentSection: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto md:mx-0">
      <h1 className="text-6xl md:text-7xl lg:text-8xl font-bold leading-[1.2] mb-6">
        <div className="text-[#002855] leading-[1.2]">Demandas</div>
        <div className="text-[#f57c35] leading-[1.2]">com eficiência</div>
      </h1>
