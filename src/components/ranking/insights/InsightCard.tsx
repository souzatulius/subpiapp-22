...
const InsightCard: React.FC<InsightCardProps> = ({
  ...
  return <Card className={`p-3 border ${isSimulated ? 'border-blue-300 bg-blue-50/50' : 'border-gray-200'} hover:shadow-md transition-all`}>
      ...
      {isLoading ? <>
          ...
          <div className="flex items-center">
            <p className="font-bold mb-1 text-orange-600 text-3xl">{formatValue(value)}</p>
