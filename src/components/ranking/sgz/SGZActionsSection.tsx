...
const SGZActionsSection = () => {
  ...
  return (
    <div className="flex flex-wrap gap-2 justify-end print:hidden">
      <Button variant="outline" onClick={handleExportPDF} className="text-orange-600 border-orange-200 hover:bg-orange-50">
        <FileText className="mr-2 h-4 w-4" />
        Baixar Relatório em PDF
      </Button>
      <Button variant="outline" onClick={handleExportExcel} className="text-orange-600 border-orange-200 hover:bg-orange-50">
        <Download className="mr-2 h-4 w-4" />
        Exportar Dados para Excel
      </Button>
      <Button variant="outline" onClick={handlePrint} className="text-orange-600 border-orange-200 hover:bg-orange-50">
...
export default SGZActionsSection;
